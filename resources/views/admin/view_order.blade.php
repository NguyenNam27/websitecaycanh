        ...
        @foreach($order_details as $key => $details)
          ...
          <tr class="color_qty_{{$details->product_id}}">
            ...
            <td>
              ...
              <input type="number" disabled min="1" {{$order_status==2 ? 'disabled' : ''}} class="order_qty_{{$details->product_id}}" value="{{$details->product_sales_quantity}}" name="product_sales_quantity">
             ...
             @if($order_status!=2)
              ...
              <button class="btn btn-default update_quantity_order" data-product_id="{{$details->product_id}}" name="update_quantity_order" disabled>Cập nhật</button>
